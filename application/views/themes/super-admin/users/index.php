					...
					<div class="bs-example widget-shadow" data-example-id="contextual-table"> 
                        ...
                        foreach ($users as $item):?>
								<tr class="active"> 
                                    ...
                                    <td><form><a href='<?php echo base_url(); ?>admin/users/edit?id=<?php echo $item->id ;?>' >Edit</a><a href='<?php echo base_url(); ?>admin/users/delete?id=<?php echo $item->id ;?>' style="margin-left: 10px;">Delete</a></td>
								</tr> 
						<?php
                        $c++;
                     endforeach;?>
