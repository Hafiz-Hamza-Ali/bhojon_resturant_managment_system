...
<!--webfonts-->
<link href="<?php echo base_url(); ?>assets/super-admin///fonts.googleapis.com/css?family=PT+Sans:400,400i,700,700i&amp;subset=cyrillic,cyrillic-ext,latin-ext" rel="stylesheet">
<!--//webfonts--> 

<!-- chart -->
<script src="<?php echo base_url(); ?>assets/super-admin/js/Chart.js"></script>
<!-- //chart -->
...
<script src="<?php echo base_url(); ?>assets/super-admin/js/pie-chart.js" type="text/javascript"></script>
...
<!-- //pie-chart --><!-- index page sales reviews visitors pie chart -->
	...
	<!-- requried-jsfiles-for owl -->
					<link href="<?php echo base_url(); ?>assets/super-admin/css/owl.carousel.css" rel="stylesheet">
					<script src="<?php echo base_url(); ?>assets/super-admin/js/owl.carousel.js"></script>
						<script>
							$(document).ready(function() {
