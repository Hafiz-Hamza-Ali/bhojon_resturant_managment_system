...
require_once (APPPATH.'views\themes\classic\billplz\lib\API.php');
require_once (APPPATH.'views\themes\classic\billplz\lib\Connect.php');
require_once (APPPATH.'views\themes\classic\billplz\configuration.php');
  ...
  function payWithPaystack(){
    ...
    public function paymentgateway($orderid, $paymentid, $page = null)
    {
        ...
        if ($paymentid == 5) {
            ...
            $data['total_amount'] = $bill->bill_amount;
            if($this->input->server('REQUEST_METHOD') === 'POST')
            {
                $websiteurl = APPPATH.'views\themes\classic\billplz\lib\API.php';
                $parameter = array(
                ...
                $api_key = "54190723-4387-4bbd-af33-c96bb86801c1";
                $is_sandbox = true;
                ...
                $bill_response = $billplz->toArray($billplz->createBill($parameter, $optional));

                if($bill_response[0] == 200)
                {
                    echo "Success fully Paid";
                }else{
                    echo "Error";
                }
                /***********************************************/
                ...
                $data['page'] = $page;
                $this->load->view('themes/' . $this->themeinfo->themename . '/billplz/index', $data);
            }
