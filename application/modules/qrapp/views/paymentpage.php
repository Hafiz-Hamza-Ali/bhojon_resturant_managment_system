                ...
                <?php if (!empty($paymentlist)) {
					...
					<div class="row bg-brown">
                             <div class="col-sm-12 kitchen-tab">
                                                ...
                                                <input id="chkbox-<?php echo $payments->payment_method_id; ?>" type="checkbox" class="individual qrpayments" <?php if($payments->payment_method_id==$newarray[$payments->payment_method_id]){ echo "checked";}?> name="<?php echo $payments->payment_method; ?>" value="<?php echo $payments->payment_method_id; ?>" <?php //if($quickorder->waiter==1){ echo "checked";}?>>
