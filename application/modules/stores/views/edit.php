    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open_multipart("stores/store/update") ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                        <input name="id" class="form-control" type="hidden" placeholder="Store Name" id="foodname"   value="<?php echo $store['id'] ?>">
                            <input name="foodname" class="form-control" type="text" placeholder="Store Name" id="foodname"   value="<?php echo $store['store_name'] ?>">
                        </div>
                    </div>
					<!-- <div class="form-group row">
